<template>
  <div ref="echartRef" class="echarts"></div>
</template>
...
const initChart = (data: any) => {
  if (echarts) {
    echarts.dispose(echartRef.value as HTMLElement);
  }
  const pieChart: echarts.ECharts = echarts.init(
    echartRef.value as HTMLElement
  );
